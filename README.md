...
| [Appwrite](https://appwrite.io) | ![Shirt](icons/shirt.png) ![Socks](icons/socks.png) ![Stickers](icons/stickers.png) | Participate by creating one or more merged pull requests to any [Appwrite repository](https://github.com/appwrite). Get the complete sticker pack with limited edition socks for 3 and also a limited edition t-shirt for 4 contributions. | [Details](https://hacktoberfest.appwrite.io/) |
